        ...
        <main>
            <section id="contact">
                ...
                <?php if (!empty($flash_error)): ?>
                    <div style="padding: 10px; marggin-bottom:10px;
                ...
                <form action="proses_update.php" method="POST">
                    ...
                    <label for="txtCaptcha_Sederhana"><span>Captcha 2 x 3 = ?</span>
                        <input type="text" id="txtCaptcha_Sederhana"  name="txtCaptcha_Sederhana" 
